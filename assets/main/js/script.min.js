...
function footer() {
  var e,
    t,
    o = document.getElementById("footerLine");
  o
    ? ((e = o.getContext("2d")),
...
function magicCursor() {
  ...
  window.addEventListener("mousemove", (e) => {
    (o = e.clientX),
      (r = e.clientY),
      gsap.to(t, { x: o, y: r, opacity: 1, duration: 0.1 });
  }),
  ...
  var e = document.querySelectorAll("[data-cursor-text]"),
    i = document.querySelector(".magic-cursor .cursor");
  e.forEach((e) => {
...
let init = () => {
  gsap.registerPlugin(ScrollTrigger), animationText(), footer(), magicCursor();
};
