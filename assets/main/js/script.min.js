...
function animation() {
  gsap.utils.toArray(".parallax-trigger").forEach((e) => {
    ...
    gsap.utils.toArray(".effect-fade-in").forEach((e) => {
      var t = e.getAttribute("data-start") || "70%",
        r = e.getAttribute("data-delay") || "0";
      gsap.fromTo(
        e,
        { opacity: 0, y: 20 },
        {
          ...
          delay: r,
          ease: "power1.out",
          scrollTrigger: { trigger: e, start: "top " + t, end: "bottom " + t }
        }
      );
    });
}
function magicCursor() {
  ...
  var e = document.querySelectorAll("[data-cursor-text],a[href]"),
    o = document.querySelector(".magic-cursor .cursor");
  e.forEach((e) => {
...
function ourService() {
  ...
  $(".our-services").length < 1 ||
    ...
    document.querySelectorAll(".our-services .card").forEach((o) => {
      let s;
      function t(e) {
        var t = e.clientX,
          e = e.clientY,
  ...
  class a {
    ...
    draw() {
      r.beginPath(),
        ...
        (r.fillStyle = `rgba(255, 255, 255, ${this.opacity})`),
        r.fill();
    }
  }
  let s = Array.from({ length: 200 }, () => new a()),
    o = 0,
    i = 0;
...
function effectImgParallaxAndMove() {
  gsap.utils.toArray(".img-move-parallax").forEach((e) => {
    var t = e.querySelector("img"),
      r = e.classList.contains("move-reverse");
    gsap.set(e, { xPercent: r ? -50 : 50, autoAlpha: 0 }),
      gsap.set(t, { yPercent: -15, scale: 1.2 }),
      gsap
        .timeline({
          scrollTrigger: { trigger: e, start: "top 50%", end: "center 50%" }
        })
        .to(e, {
          xPercent: 0,
          autoAlpha: 1,
...
function formCard() {
  let e = document.querySelectorAll(".contact-form");
  e.length &&
    document
      ...
      .addEventListener("mousemove", (a) => {
        e.forEach((e) => {
          ...
          e.style.setProperty("--mouse-x", r + "px"),
            e.style.setProperty("--mouse-y", t + "px");
        });
      });
}
let init = () => {
