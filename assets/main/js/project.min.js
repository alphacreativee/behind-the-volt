...
function clipMaskImage() {
  document.querySelector(".content-detail-clip-image") &&
    (gsap.fromTo(
      ...
      { clipPath: "inset(0% 0% 0% 0%)" },
      {
        clipPath: () => {
          ...
          let e = t - 160;
          var o = ((t - (e = t < 991 ? t - 40 : e)) / 2 / t) * 100,
            i = document.querySelector(
              ".content-detail-clip-image"
            ).offsetHeight,
            t = ((i - (991 < t ? i - 100 : i)) / 2 / i) * 100;
          return `inset(${t}% ${o}% ${t}% ${o}%)`;
        },
        duration: 0.4,
        ease: "power3.out",
        scrollTrigger: {
...
function twoParallaxImage() {
  document.querySelector(".content-detail-two-image") &&
    (gsap.fromTo(
...
let init = () => {
  gsap.registerPlugin(ScrollTrigger), twoParallaxImage();
};
